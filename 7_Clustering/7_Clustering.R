...
par(mfrow=c(1,1))
# height - in this case euclidean distance between clusters (as higher height - as bigger distance between cluster)
# and we alsready have 2 clusters - they are far away from each other
...
# Fix k=2 clusters: (just choose how many cluster I wnat)
...
# maximum - try find spherical clusters 
...
# distance of two observation merget togetther, consistent with original distance 
...
# as bigger correlation as closer computed distance to our basic euclidean distance 
