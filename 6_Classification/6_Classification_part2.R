...
# Fisher Discriminant Analysis ----------------------------------------------------------------
# try to increse diversity between groups 
# (like in MANOVA variance between higher that variance within)
# also useful for visualising 
...
# Plot LDA
# given fact, that I have correlation between sepal length and width - our line
# will not be go around border of red points, and even if new point closer to Blue center, but
# lie on section of red part - it will be RED 
...
# Короче чем больше C -  тем больша штрафуем за неправильные предсказания,
# и тем сложнее разделяющая гиперплоскость
# 
