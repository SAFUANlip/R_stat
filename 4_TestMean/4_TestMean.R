###---------------------------------------------------------------###
### Lab 4: Mean Comparison for Multivariate Gaussian Observations ###
###---------------------------------------------------------------###
...
# Example 6.1 JW + exercise 6.1 JW (n=11, p=2)
...
# value of the statistics T2 = n*(a'(X-mu))^2 / a'Sa (univariate), i.e., we reject the global
...
# when we take just two intervals, 
# if we add additinoal cofidence intervals 
# adding more confidence intervals we become closer to ellipse 
# in some momment Bonferroni 
...
## Comparison between simultaneous T2 and Bonferroni intervals --------------------------------
...
# when we have just 2 groups - this test will be better (two INDEPENDENT samples) 
...
# b) Report the significant mutations, imposing a probability of at most 1% (probability of type-1 error less than 1%)
...
# (Some books recommend to have at least n1*p1 >= 5 & n2*p2 >= 5 & n1*(1-p1) >= 5 & n2*(1-p2) >= 5)
