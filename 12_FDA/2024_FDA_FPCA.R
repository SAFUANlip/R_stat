...
# First of all we smooth the data. We choose a Fourier basis (periodic, because our data periodic)
# (periodic). We need to set the dimension of the basis

time <- 1:365

# as less nbasis - as smoother graphics 
...
# when we do smoothing before PCA, avoid strong smoothing 
...
# in second PC more crutial temperature change from winter to summer
...
# Exercise: perform FPCA with Choice 1 of smoothing
